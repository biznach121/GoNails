  ...
  return (
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_1.4fr]">
      ...
      <div className="spabox-card flex flex-col p-5 sm:p-6">
        ...
        <p className="mb-2 text-xs font-medium text-[#4e3800]/68">
        ...
        <div className="no-scrollbar max-h-[420px] space-y-2 overflow-y-auto lg:max-h-[560px]">
          {filtered.length === 0 ? (
            <div className="rounded-[18px] border border-dashed border-[#422900]/20 p-6 text-center">
              <p className="m-0 text-sm font-medium text-[#4e3800]/72">No treatments match.</p>
              <button
                type="button"
                onClick={() => {
                  clearAll();
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className={`m-0 mt-0.5 text-xs ${active ? "text-[#e9f4e5]/72" : "text-[#4e3800]/68"}`}>
      ...
      <div className="spabox-card p-4 sm:p-6">
        ...
        <button
          ...
          className="mt-6 inline-flex w-full items-center justify-center gap-2 bg-[#422900] px-5 py-3 text-sm font-semibold text-[#e9f4e5] transition-colors hover:bg-[#311e00] disabled:cursor-not-allowed disabled:opacity-50"
        >
          {submitting
            ? "Confirming…"
            : selectedSlot
