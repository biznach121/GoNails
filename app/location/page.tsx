    ...
    <main className="bg-[#dee9da] text-[#422900]">
      <section className="mx-auto grid min-h-[calc(100svh-120px)] max-w-6xl gap-10 px-4 py-12 sm:px-8 sm:py-16 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:py-20">
        <div>
          ...
          <p className="mt-6 max-w-[420px] text-[16px] font-medium leading-[1.4] text-[#4e3800]/80 sm:mt-7 sm:text-[18px]">
        ...
        <div className="overflow-hidden rounded-[24px] border border-[#422900]/12 bg-[#c7dac0] shadow-[0_26px_80px_rgba(66, 41, 0,0.12)] sm:rounded-[28px]">
          <iframe
