  ...
  return (
    <article className="spabox-page">
      <div className="spabox-shell">
            ...
            <dl className="space-y-6">
              {section.items.map((item) => (
                <div key={item.q}>
                  ...
                  <dd className="m-0 text-[15px] font-medium leading-relaxed text-[#4e3800]/76">
                    {item.a}
                  </dd>
                </div>
              ))}
        ...
        <p className="mt-8 border-t border-[#422900]/12 pt-7 text-[15px] font-medium text-[#4e3800]/76">
          {f.contactPrompt}{" "}
