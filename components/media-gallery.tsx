...
export function MediaGallery() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#dee9da] px-4 pb-24 pt-14 text-[#422900] sm:px-8">
      <svg
        className="pointer-events-none absolute -left-16 -top-36 z-0 h-96 w-[520px] text-[#7e8768]/28"
        viewBox="0 0 520 380"
        fill="none"
        aria-hidden="true"
      >
          ...
          {items.map((image) => {
            ...
            return (
              <div
                key={image.src}
                data-media-card
                className="relative aspect-[3/4] w-[80%] shrink-0 snap-start overflow-hidden rounded-[26px] bg-[#c7dac0] shadow-[0_20px_54px_rgba(66, 41, 0,0.16)] sm:w-[46%] lg:w-[calc((100%-2.5rem)/3)]"
              >
                {isVideo ? (
                  <video
                    src={image.src}
