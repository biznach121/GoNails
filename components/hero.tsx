...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#504500] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#5e4d00]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(52, 42, 0,0.58),rgba(74, 52, 0,0.22)_43%,rgba(54, 45, 0,0.34)),linear-gradient(0deg,rgba(27, 24, 0,0.18),rgba(27, 24, 0,0.08))]" />
