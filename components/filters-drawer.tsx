      ...
      >
        <header className="flex items-center justify-between border-b border-[#422900]/12 px-6 py-5">
          ...
          <button
            ...
            className="grid h-10 w-10 place-items-center rounded-full border border-[#422900]/12 bg-[#e9f4e5] text-[#422900] transition-colors hover:bg-[#c7dac0]"
          >
            ✕
          </button>
        </header>
        ...
        <footer className="flex items-center gap-3 border-t border-[#422900]/12 px-6 py-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="h-12 flex-1 rounded-full bg-[#422900] text-sm font-semibold text-[#e9f4e5] transition-colors hover:bg-[#311e00]"
          >
            Show {resultCount}
          </button>
        </footer>
