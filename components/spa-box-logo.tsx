...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783494230/stage4/spa_gonailsofficiall/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="GO Nails - Luxury pedicures and manicures">
        <Image
          src={src}
          alt="GO Nails - Luxury pedicures and manicures"
          fill
