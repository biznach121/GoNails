        ...
        {brand.serviceBands.map((service) => (
          ...
          >
            ...
            <div className="relative z-10 flex h-full flex-col justify-center px-9 py-7 sm:px-16 lg:px-[11%]">
              ...
              >
                <ServiceGlyph />
                <span className="inline-flex h-14 items-center bg-[#e9f1e6]/92 px-7 text-[13px] font-semibold uppercase transition-colors group-hover:bg-white sm:h-16 sm:px-9">
                  {service.ctaLabel}
                </span>
              </Link>
            </div>
