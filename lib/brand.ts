...
export const brand: Brand = {
  name: "GO Nails",
  shortName: "GO Nails",
  microTag: "LUXURY PEDICURES AND MANICURES",
  description:
    "GO Nails in Accra is where nails get the time and detail they deserve — clean sets, careful prep and finishes that last.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0303981955",
    phoneTel: "+233303981955",
    textPhone: "0303981955",
    textPhoneTel: "+233303981955",
    email: "hello@gonails.test",
    privacyEmail: "privacy@gonails.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@gonailsofficiall", icon: "tiktok" },
  ],
  ...
  hero: {
    ...
    subtitle:
      "Manicures, pedicures and nail art in Accra — walk in or book your slot",
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "GO Nails exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "GO Nails beauty treatment detail",
      ...
      },
      {
        ...
        alt: "GO Nails self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "GO Nails beauty ritual",
    ...
    items: [
      {
        ...
        imageAlt: "GO Nails lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "GO Nails mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "GO Nails makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "GO Nails foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About GO Nails",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "GO Nails is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0303981955 and text 0303981955 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0303981955, text 0303981955, or message @gonailsofficiall on Instagram." },
          ...
          { q: "Where are you located?", a: "GO Nails is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@gonails.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "GO Nails (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@gonails.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "GO Nails is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@gonails.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to GO Nails",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0303981955", href: "tel:+233303981955" },
      { label: "Text", value: "0303981955", href: "sms:+233303981955" },
      { label: "Instagram", value: "@gonailsofficiall", href: "https://www.tiktok.com/@gonailsofficiall" },
    ],
  },
  ...
  footer: {
    logoUrl: "https://res.cloudinary.com/dzykdnbvb/image/upload/v1783494231/stage4/spa_gonailsofficiall/avatar.jpg",
    blurb:
      "GO Nails in Accra — luxury pedicures and manicures.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@gonailsofficiall" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0303981955", href: "tel:+233303981955" },
          { label: "Text 0303981955", href: "sms:+233303981955" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "GO Nails — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
